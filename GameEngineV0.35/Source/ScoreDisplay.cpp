...
#pragma warning( push )
#pragma warning( disable : 4244 )
        playerText_.SetColor( it->color_.r * 255, it->color_.g * 255, it->color_.b * 255, it->color_.a * 255 );
#pragma warning( pop )
...
#pragma warning( push )
#pragma warning( disable : 4244 )
        current.SetColor( it->color_.r * 255, it->color_.g * 255, it->color_.b * 255, it->color_.a * 255 );
#pragma warning( pop )
